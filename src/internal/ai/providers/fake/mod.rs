//! Test-only deterministic provider used by local Code UI automation harnesses.
//!
...
//! provider-neutral completion responses so the real Code UI, tool loop, approval,
