...
fn builtin_migrations_register_current_schema_migrations() {
    ...
    assert_eq!(runner.max_registered_version(), Some(2026081801));
}
...
async fn agent_subagent_content_up_down_up_and_nonempty_guard() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            2026080401, 2026080402, 2026080403, 2026081301, 2026081801
        ]
    );
    conn.execute_raw(Statement::from_string(
        conn.get_database_backend(),
    ...
    assert_eq!(
        ...
        vec![
            ...
            2026073101, 2026080401, 2026080402, 2026080403, 2026081301, 2026081801
        ]
    );
    assert!(table_exists(&conn, "agent_subagent_content_claim").await);
    assert!(table_exists(&conn, "agent_capture_incarnation").await);
...
async fn agent_import_identity_tombstone_up_down_up_round_trip() {
    ...
    assert_eq!(
        rolled,
        vec![
            2026081801, 2026081301, 2026080403, 2026080402, 2026080401, 2026073101, 2026073005,
    ...
    assert_eq!(
        ...
        vec![
            ...
            2026080403, 2026081301, 2026081801
        ]
    );
    assert!(table_exists(&conn, "agent_import_identity").await);
    assert!(table_exists(&conn, "agent_import_tombstone").await);
...
async fn worktree_registry_v2_capability_marker_round_trip() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            2026080402, 2026080403, 2026081301, 2026081801
        ]
    );
    assert!(table_exists(&conn, "worktree_registry_capability").await);
    assert_eq!(
...
async fn stash_generation_fence_up_down_up_round_trip() {
    ...
    assert_eq!(
        rolled,
        vec![
            2026081801, 2026081301, 2026080403, 2026080402, 2026080401, 2026073101
        ],
