...
| `agent_bridge_mutation_test` | 1 | plan-20260818 LB-05 mutations: operation-id mandatory + idempotent, digest conflict fails closed, actor spoof rejected, checkpoint.create real, commit/restore not-wired fail closed | `src/internal/ai/agent_bridge/{mutations,authorization,provenance}.rs` |
