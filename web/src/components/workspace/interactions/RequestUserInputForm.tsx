...
export interface RequestUserInputFormProps {
  ...
  /** When false, show the questions read-only (managed Codex cannot resolve posts). */
...
export function RequestUserInputForm({
  ...
  return (
    <section aria-label="User input request">
      ...
      {!respondEnabled && (
        <p role="status">
          This managed Codex session cannot resolve user-input prompts from the browser. Answer them
