...
export interface ApprovalPanelProps {
  ...
  /** When false, show the request read-only (respond path unavailable). */
...
export function ApprovalPanel({
  ...
  return (
    <section aria-label="Approval request">
      ...
      {!respondEnabled && (
        <p role="status">
          This session cannot resolve approvals from the browser right now. Cancel the turn here, or
          retry once the controller can write.
        </p>
      )}
